...
export const featured: FeaturedProject[] = [
  {
    ...
    tags: ['AI Skill', '产品策划'],
    cover: '/works/feat-ideasalon.webp',
  },
  {
    id: 'muse-council',
    title: 'Muse Council',
  ...
  },
  {
    ...
    cover: '/works/feat-frameprompt.webp',
  ...
  },
  {
    ...
    cover: '/works/feat-designspec.webp',
...
export const projectDetails: Record<string, ProjectDetail> = {
  'idea-salon': {
    ...
    gallery: [
      { src: '/works/is-p01.webp', caption: '项目封面：面向设计工作坊的 AI 共创 Skill（Moderation · Roles · Flow）' },
      { src: '/works/is-p02.webp', caption: '痛点洞察：学生的卡点分布在整个设计流程' },
      { src: '/works/is-p03.webp', caption: '竞品分析：通用 AI 工具撑不起一场设计工作坊' },
      { src: '/works/is-p04.webp', caption: '从竞品痛点转化为四个创新点' },
      { src: '/works/is-p05.webp', caption: '核心机制：Skill 是引擎，专家是界面' },
      { src: '/works/is-p06.webp', caption: '工作流：先独立思考，再团队收敛' },
      { src: '/works/is-p07.webp', caption: '价值闭环：学生、团队、老师各取所需' },
      { src: '/works/is-p08.webp', caption: '场景一 · 启动圆桌：匹配专家老师，生成项目 Brief' },
      { src: '/works/is-p09.webp', caption: '场景二 · 方法论介入：专家分身一对一辅导调研' },
      { src: '/works/is-p10.webp', caption: '场景三 · 洞察提炼：从洞察到 HMW，团队投票定方向' },
      { src: '/works/is-p11.webp', caption: '场景四 · 概念发散：候选方向 + Moodboard，投票收敛' },
      { src: '/works/is-p12.webp', caption: '场景五 · 团队接续：读取画板进度，无缝继续创作' },
      { src: '/works/is-p13.webp', caption: '场景六 · 设计评审：六维评估，产出可交付设计稿' },
    ],
    links: [
      { label: 'Demo 视频', href: 'https://www.bilibili.com/video/BV1jfu26QE1K/', kind: 'video' },
      { label: '汇报 PDF', href: '/works/idea-salon.pdf', kind: 'pdf' },
    ],
  },
  ...
  'muse-council': {
    ...
    gallery: [
      { src: '/works/mc-entry.webp', caption: '圆桌首页入口：与她们坐一桌，写下你在想的事' },
      { src: '/works/mc-pioneers.webp', caption: '先行者邀请页：9 位古今女性角色卡' },
      { src: '/works/mc-roundtable.webp', caption: '圆桌对话：六阶段流程（课题→入席→回应→讨论→收束→行动），分阶段发言与追问' },
      { src: '/works/mc-actioncard.webp', caption: '收成页：行动卡 + 金句卡 + 我的一句' },
    ],
    links: [
  ...
  frameprompt: {
    ...
    gallery: [
      { src: '/works/fp-workbench.webp', caption: '创建 Prompt 工作台：画面拆解 + 适配与预检' },
      { src: '/works/fp-precheck.webp', caption: '可解释的适配与预检：五维评分 + Baseline→Adapted 对照', cls: 'sm:w-[82%] sm:mx-auto' },
      { src: '/works/fp-cards.webp', caption: 'Prompt Card 库与预检有效性验证' },
    ],
    links: [
      { label: '在线体验', href: '#', kind: 'demo', pending: true },
...
export const moreWorks: MoreWork[] = [
  {
    ...
    period: '2025.09-11',
    cover: '/works/more-yiqida.webp',
    ratio: 'landscape',
    link: '/works/yiqida.pdf',
    linkLabel: '阅读完整 PDF',
    video: '/works/yiqida.mp4',
    size: 'lg',
    rotate: -1.4,
  },
  {
    ...
    cover: '/works/more-studio1.webp',
    ratio: 'landscape',
    link: '/works/studio1-thyroid.pdf',
    linkLabel: '阅读完整 PDF',
    size: 'sm',
    rotate: 1.2,
  },
  {
    ...
    period: '2025.12',
    cover: '/works/more-culture.webp',
    ratio: 'landscape',
    link: '/works/culture-game.pdf',
    linkLabel: '阅读完整 PDF',
    size: 'sm',
    rotate: 1.6,
  },
  {
    ...
    period: '2026.03-04',
    cover: '/works/more-blender.webp',
    ratio: 'landscape',
    link: '/works/blender-exoskeleton.pdf',
    linkLabel: '阅读完整 PDF',
    size: 'md',
    rotate: -1.2,
  },
  {
    ...
    period: '2026.05-06',
    cover: '/works/more-muselens.webp',
    ratio: 'landscape',
    link: '/works/muselens.pdf',
    linkLabel: '阅读完整 PDF',
    size: 'lg',
    rotate: 1,
  },
